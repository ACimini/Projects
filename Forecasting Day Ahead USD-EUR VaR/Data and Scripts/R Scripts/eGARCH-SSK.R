...
eGARCH_SSK <- data[, 1:3]
eGARCH_SSK$ES0.01 <- NA
eGARCH_SSK$ES0.025 <- NA
eGARCH_SSK$ES0.05 <- NA
eGARCH_SSK$ES0.95 <- NA
eGARCH_SSK$ES0.975 <- NA
eGARCH_SSK$ES0.99 <- NA

for (i in start_day:(total_days - 1)) {
  window_data <- data[(i - window_size):(i - 1), ]
  
  # Specify the EGARCH model with the correct syntax
  ...
  eGARCH_SSK$ES0.01[i + 1] <- ES_01
  eGARCH_SSK$ES0.025[i + 1] <- ES_025
  eGARCH_SSK$ES0.05[i + 1] <- ES_05
  
  eGARCH_SSK$ES0.95[i + 1] <- ES_95
  eGARCH_SSK$ES0.975[i + 1] <- ES_975
  eGARCH_SSK$ES0.99[i + 1] <- ES_99
...
valid_data <- eGARCH_SSK %>% filter(!is.na(ES0.01))
...
write.csv(eGARCH_SSK, file = "eGARCH_SSK.csv")
