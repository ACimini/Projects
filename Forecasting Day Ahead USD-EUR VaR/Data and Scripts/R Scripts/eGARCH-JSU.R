...
eGARCH_JSU <- data[, 1:3]
eGARCH_JSU$ES0.01 <- NA
eGARCH_JSU$ES0.025 <- NA
eGARCH_JSU$ES0.05 <- NA
eGARCH_JSU$ES0.95 <- NA
eGARCH_JSU$ES0.975 <- NA
eGARCH_JSU$ES0.99 <- NA
...
for (i in start_day:(total_days - 1)) {
  ...
  eGARCH_JSU$ES0.01[i + 1] <- ES_01
  eGARCH_JSU$ES0.025[i + 1] <- ES_025
  eGARCH_JSU$ES0.05[i + 1] <- ES_05
  
  eGARCH_JSU$ES0.95[i + 1] <- ES_95
  eGARCH_JSU$ES0.975[i + 1] <- ES_975
  eGARCH_JSU$ES0.99[i + 1] <- ES_99
...
valid_data <- eGARCH_JSU %>% filter(!is.na(ES0.01))
...
write.csv(eGARCH_JSU, file = "eGARCH_JSU.csv")
